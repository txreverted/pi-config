...
- [`extensions/memory.ts`](extensions/memory.ts) provides default-on,
  ...
  entries. See [memory tests](https://github.com/txreverted/pi-config/blob/main/test/memory-extension.test.mjs).
- [`extensions/ask.ts`](extensions/ask.ts) provides `ask_user_question` in TUI
  ...
  See [ask tests](https://github.com/txreverted/pi-config/blob/main/test/ask-extension.test.mjs).
- [`extensions/web.ts`](extensions/web.ts) provides Firecrawl-backed `web_search`
  ...
  [web tests](https://github.com/txreverted/pi-config/blob/main/test/web-core.test.mjs).
- [`extensions/ui.ts`](extensions/ui.ts) configures the editor, footer,
  thinking-colored working indicator, response duration, and wrapped input.
  Thinking-level changes do not rebuild the transcript. `/fast [on|off]` adds
  the priority tier only for official OpenAI GPT-5.6 APIs and persists on the
  current branch. See [UI tests](https://github.com/txreverted/pi-config/blob/main/test/ui-extension.test.mjs).
- [`extensions/ponytail.ts`](extensions/ponytail.ts) and
  ...
  [policy tests](https://github.com/txreverted/pi-config/blob/main/test/policies.test.mjs).
- [`/R-DOCS [scope]`](prompts/R-DOCS.md) rebuilds docs, including
  ...
  [config tests](https://github.com/txreverted/pi-config/blob/main/test/config.test.mjs).
