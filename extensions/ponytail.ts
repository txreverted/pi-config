...
Full mode default: enforce ladder. User may request lite: build asked scope, then name lazier alternative once. Ultra: challenge speculative scope and prefer deletion, while honoring confirmed requirements. "Stop ponytail" or "normal mode" suspends it until user reactivates it.
