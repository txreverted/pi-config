# Desired Config
   ...
   “Claude Code-like” applies to both features and UI: workflows, interaction flow, layout, visual hierarchy, controls, selection states, keyboard navigation, progress, and status presentation.
 ...
 kept, merged, deleted, protected, and unresolved files.
   ...
   Give evidence and a short rationale for every score. Report strengths and findings by impact. Cite exact files and symbols. Separate facts from inference. Explain concrete risk. Prefer the
 ...
 overwrite, expose secrets, bypass safeguards, or force-push. Keep tests and required documentation with implementation. Use atomic commits. Wait for required checks. Merge only when repository
